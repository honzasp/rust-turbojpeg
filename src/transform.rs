...
pub struct Transform {
    ...
    /// Enable progressive entropy coding in the output image.
    ///
    ...
    /// Enable arithmetic entropy coding in the output image.
    ///
    /// Arithmetic entropy coding improves the compression ratio relative to the default Huffman
    /// entropy coding, but it makes the compression and decompression considerably slower.
    #[doc(alias = "TJXOPT_ARITHMETIC")]
    pub arithmetic: bool,

    /// Enable optimized baseline entropy coding in the output image.
    ///
